...
typedef void (*LoggerHook)(LogLevels, const char* msg, void* data);

struct LoggerHookData {
	LoggerHook hook;
	void* data;
};
...
class Logger {
	public:
		...
		static void add_hook(LoggerHook, void*);
		static void remove_hook(LoggerHook, void*);
...
//	private:
		...
		static vector<LoggerHookData> hooks;
